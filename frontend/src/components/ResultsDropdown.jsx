...
const SearchResult = ({ channel, focusedId, type, setChannel, setToggleContainer, client, setActiveChannel }) => {
    if (type === 'channel') {
      return (
        <div
          onClick={() => {
    ...
    return (
      ...
      >
        <div className='channel-search__result-user'>
          {/* Replace with your custom avatar component or HTML structure */}
          <img src={channel.image || 'default-avatar-image-url'} alt={channel.name} className='avatar-image' />
